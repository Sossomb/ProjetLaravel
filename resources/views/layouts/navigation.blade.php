<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'gestionnaire')
                        <x-nav-link :href="route('admin.commandes.index')" :active="request()->routeIs('admin.commandes.index')">
                            {{ __('Commandes') }}
                        </x-nav-link>
                    ...
                    <!-- Menu commun pour tous les utilisateurs -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()->role === 'gestionnaire')
                <x-responsive-nav-link :href="route('admin.commandes.index')" :active="request()->routeIs('admin.commandes.index')">
                    {{ __('Commandes') }}
                </x-responsive-nav-link>
